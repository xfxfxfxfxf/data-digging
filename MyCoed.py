prediction_stderr = 0.0073
train_test_logmean_diff = 0.1
probthresh = 90
rounder = 2 
...
test.loc[bad_index, "full_sq"] = np.NaN
bad_index = train[train.life_sq > 210].index
train.loc[bad_index, ["life_sq", "full_sq"]] = np.NaN
bad_index = test[test.life_sq > 210].index
test.loc[bad_index, ["life_sq", "full_sq"]] = np.NaN
train.product_type.value_counts(normalize= True)
test.product_type.value_counts(normalize= True)
bad_index = train[train.build_year < 1800].index
train.loc[bad_index, "build_year"] = np.NaN
bad_index = test[test.build_year < 1800].index
...
train['livArea_ratio'] = train['life_sq'] / train['full_sq'].astype(float) 
train['yrs_old'] = 2017 - train['build_year'].astype(float) 
train['avgfloor_sq'] = train['life_sq']/train['max_floor'].astype(float) 
...
train['kg_park_ratio'] = train['kindergarten_km']/train['park_km'].astype(float) 
train['high_ed_extent'] = train['school_km'] / train['kindergarten_km'] 
train['pts_x_state'] = train['public_transport_station_km'] * train['state'].astype(float) 
train['lifesq_x_state'] = train['life_sq'] * train['state'].astype(float) 
train['floor_x_state'] = train['floor'] * train['state'].astype(float) 
...
test['avgfloor_sq'] = test['life_sq']/test['max_floor'].astype(float) 
test['pts_floor_ratio'] = test['public_transport_station_km']/test['max_floor'].astype(float) 
...
test['pts_x_state'] = test['public_transport_station_km'] * test['state'].astype(float) 
...
df_all['avgfloor_sq'] = df_all['life_sq']/df_all['max_floor'].astype(float)
df_all['pts_floor_ratio'] = df_all['public_transport_station_km']/df_all['max_floor'].astype(float)
...
df_all['pts_x_state'] = df_all['public_transport_station_km'] * df_all['state'].astype(float)
